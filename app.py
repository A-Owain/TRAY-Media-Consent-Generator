...
if st.button("Generate & Download Consent ZIP"):
    if name and national_id:
        ...
        arabic_lines = [
            ...
            "",
            f"(TRAY).أُقرّ أنا، {name}، صاحب الهوية رقم {national_id}؛",
            "",
            "ﺑﻤﻨﺢ ﺷﺮﻛﺔ ﺍﻟﺤﻠﻮﻝ ﺍﻟﺮﻗﻤﻴﺔ ﺍﻟﺮﺍﺋﺪﺓ ﻟﺘﻘﻨﻴﺔ ﺍﻟﻤﻌﻠﻮﻣﺎﺕ (TRAY) ﻭﻏﻴﺮ ﺍﻟﻤﻘﻴﺪ ﻓﻲ ﺗﺼﻮﻳﺮﻱ ﺃﻭ ﺗﺴﺠﻴﻞ ﺻﻮﺗﻲ ﺃﻭ ﺍﺳﺘﺨﺪﺍﻡ ﺍﺳﻤﻲ ﺃﻭ ﺻﻮﺭﺗﻲ ﺃﻭ ﺻﻮﺗﻲ ﺃﻭ ﻛﻠﻤﺎﺗﻲ ﺍﻟﺤﻖ ﺍﻟﻜﺎﻣﻞ ﻓﻲ ﺃﻱ ﻣﺤﺘﻮﻯ ﺇﻋﻼﻣﻲ ﻳﺘﻢ ﺇﻧﺘﺎﺟﻪ ﻷﻏﺮﺍﺽ ﺗﺴﻮﻳﻘﻴﺔ ﺃﻭ ﺗﻌﻠﻴﻤﻴﺔ ﺃﻭ ﺗﺮﻭﻳﺠﻴﺔ ﺃﻭ ﺩﺍﺧﻠﻴﺔ."
            "",
