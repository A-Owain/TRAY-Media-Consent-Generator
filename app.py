...
if st.button("Generate & Download Consent ZIP"):
    if name and national_id:
        ...
        arabic_lines = [
            ...
            "",
            f"بمنح شركة الحلول الرقمية الرائدة لتقنية المعلومات (TRAY) وغير المقيد في تصويري أو تسجيل صوتي أو استخدام اسمي أو صورتي أو صوتي أو كلماتي الحق الكامل في أي محتوى إعلامي يتم إنتاجه لأغراض تسويقية أو تعليمية أو ترويجية أو داخلية.أُقرّ أنا، {name}، صاحب الهوية رقم {national_id}، ",
            "",
